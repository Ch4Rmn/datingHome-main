                ...
                <div class="" ng-if="userInfo">
                    ...
                    <div class="form-control form-control-lg border border-1 border-black rounded rounded-4 mt-2" style="width:81vh;">
                        <div class="row" style="width:81vh;">
                            <div class="col">
                                <label for="height">Choose your feet</label>
                            ...
                            <div class="col">
                                <label for="height">Choose your inches</label>
                    ...
                    <div class="form-control form-control-lg border border-1 border-black rounded rounded-4 mt-2" style="width:81vh;">
                        <div class="row" style="width:81vh;">
                            <div class="col ">
                                <label for="">Choose your partner min ages</label>
                            ...
                            <div class="col ">
                                <label for="">Choose your partner max ages</label>
                ...
                <div ng-if="userPhoto">
                    ...
                    <div class="container">
                        <table style="width:100%">
                            <tr>
                                <td class="" colspan="2">
                                    <div class="img-fluid img-thumbnail border border-dark rounded m-2 d-flex justify-content-center align-items-center rounded-4 mt-2" style="height:48vh;cursor:pointer;overflow:hidden;width:400px;object-fit: contain;" ng-click="upload1()" id="upload1-icons">
                                        <i class="fa fa-upload fs-1"></i>
                                ...
                                <td class="row">
                                    <div class="img-fluid img-thumbnail border border-dark rounded m-2 d-flex justify-content-center align-items-center rounded-4 mt-2" style="height:24vh;cursor:pointer;overflow:hidden;width:150px;object-fit: contain;" ng-click="upload2()" id="upload2-icons">
                                        <i class="fa fa-upload fs-1"></i>
                                        <div class="" id="preview2" style="display: none;">
                                </td>
                                <td class="row">
                                    <div class="img-fluid img-thumbnail border border-dark rounded m-2 d-flex justify-content-center align-items-center rounded-4 mt-2" style="height:24vh;cursor:pointer;overflow:hidden;width:150px;object-fit: contain;" ng-click="upload3()" id="upload3-icons">
                                        <i class="fa fa-upload fs-1"></i>
                                        <div class="" id="preview3" style="display: none;">
                                </td>
                            </tr>
                            <td class="">
                                <div class="img-fluid img-thumbnail border border-dark rounded m-2 d-flex justify-content-center align-items-center rounded-4 mt-2" style="height:24vh;cursor:pointer;overflow:hidden;width:150px;object-fit: contain;" ng-click="upload4()" id="upload4-icons">
                                    <i class="fa fa-upload fs-1"></i>
