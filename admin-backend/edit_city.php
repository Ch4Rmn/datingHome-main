...
$user_sql = "SELECT * FROM city WHERE id='$id' AND deleted_at IS NULL";
...
if ($user_num_row > 0) {
    ...
    $error = true;
    $errorMessage = 'City not found or Deleted from Our Main Server!';
    $showForm = false;
}
?>
        ...
        <div class="row shadow-sm">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="<?php echo $adminBaseUrl ?>update_city.php?id=<?php echo $id; ?>" method="POST">
